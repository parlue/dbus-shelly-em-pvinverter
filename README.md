...
Idea is inspired on @fabian-lauer project and @vikt0rm linked below.
...
- Shelly EM with latest firmware (20220209-094317/v1.11.8-g8c7bb8d)
  - Measuring AC output of PV-Inverter on phase L3
...
### Details / Process
As mentioned above the script is inspired by @fabian-lauer dbus-shelly-3em-smartmeter and vikt0rm dbus-shelly-1pm-pvinverter implementation.
...
```
wget https://github.com/eddy0815/dbus-shelly-em-pvinverter/archive/refs/heads/main.zip
